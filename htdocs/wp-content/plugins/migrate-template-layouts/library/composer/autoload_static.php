...
class ComposerStaticInit9b6a2bd05821db49985eee193fb8a406
{
    ...
    public static $classMap = array (
        ...
        'TLM_Admin' => __DIR__ . '/../..' . '/application/controllers/TLM_Admin.php',
        'TLM_EditorDialogs' => __DIR__ . '/../..' . '/application/controllers/TLM_Dialog.php',
        'TLM_FactoryTranslationHelper' => __DIR__ . '/../..' . '/application/models/TLM_FactoryTranslationHelper.php',
        'TLM_GroupedLayouts' => __DIR__ . '/../..' . '/application/models/TLM_GroupedLayouts.php',
        'TLM_Helper_Twig' => __DIR__ . '/../..' . '/application/controllers/TLM_Helper_Twig.php',
        'TLM_LayoutsGroupedHelper' => __DIR__ . '/../..' . '/application/models/TLM_LayoutsGroupedHelper.php',
        'TLM_Main' => __DIR__ . '/../..' . '/application/TLM_Main.php',
        'TLM_MigratePreProcess' => __DIR__ . '/../..' . '/application/models/TLM_MigratePreProcess.php',
        'TLM_MigrationObject' => __DIR__ . '/../..' . '/application/models/TLM_MigrationObject.php',
        'TLM_Migration_Candidate_Query' => __DIR__ . '/../..' . '/application/models/TLM_Migration_Candidate_Query.php',
        'TLM_PrivateLayoutFactory' => __DIR__ . '/../..' . '/application/models/TLM_PrivateLayoutFactory.php',
        ...
        'xrstf_Composer52_ClassLoader' => __DIR__ . '/..' . '/xrstf/composer-php52/lib/xrstf/Composer52/ClassLoader.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit9b6a2bd05821db49985eee193fb8a406::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit9b6a2bd05821db49985eee193fb8a406::$prefixDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInit9b6a2bd05821db49985eee193fb8a406::$prefixesPsr0;
            $loader->classMap = ComposerStaticInit9b6a2bd05821db49985eee193fb8a406::$classMap;
