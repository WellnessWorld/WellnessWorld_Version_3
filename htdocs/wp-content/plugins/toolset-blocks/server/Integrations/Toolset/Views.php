...
namespace ToolsetBlocks\Integrations\Toolset;
...
class Views {
	...
	public function initialize() {
		add_action( 'toolset_blocks/filters/localize', array( $this, 'localize_toolset_blocks' ) );
	...
	public function localize_toolset_blocks( $localization_array ) {
