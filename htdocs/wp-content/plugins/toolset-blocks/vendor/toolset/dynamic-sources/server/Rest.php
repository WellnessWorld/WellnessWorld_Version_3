...
class Rest {
	...
	public function initialize() {
		add_action( 'rest_api_init', array( $this, 'register_render_source_rest_api_routes' ), 11 );

		add_action( 'rest_api_init', array( $this, 'register_cache_rest_api_routes' ), 11 );
	}
	...
	public function get_cache( \WP_REST_Request $request ) {
		...
		$response = apply_filters( 'toolset/dynamic_sources/filters/cache', array(), $post );
